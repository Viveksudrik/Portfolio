...
type MeshWithMaterial = THREE.Mesh & { material: THREE.MeshStandardMaterial };
...
export function setCharTimeline(
  ...
  let screenLight: MeshWithMaterial | undefined, monitor: MeshWithMaterial | undefined;
  character?.children.forEach((object: THREE.Object3D) => {
    ...
    if (object.name === "screenlight") {
      const sl = object as MeshWithMaterial;
      sl.material.transparent = true;
      sl.material.opacity = 0;
      sl.material.emissive.set("#B0F5EA");
